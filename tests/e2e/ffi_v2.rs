...
struct ApiV2 {
    ...
    function_context_size: u32,
    context_param_size: u32,
    context_var_size: u32,
    context_base_member_size: u32,
    context_enum_variant_size: u32,
    context_base_type_size: u32,
    context_callee_size: u32,
    lift_quality_size: u32,
    interproc_seed_size: u32,
    interproc_scope_size: u32,
    interproc_plan_size: u32,
    source_function_interface_size: u32,
    source_parameter_size: u32,
    source_parameter_type_size: u32,
    source_carrier_projection_size: u32,
    source_type_size: u32,
    source_aggregate_member_size: u32,
    source_aggregate_layout_size: u32,
    source_register_size: u32,
    source_stack_slot_size: u32,
    source_storage_size: u32,
    source_call_argument_size: u32,
    source_call_site_interface_size: u32,
    byte_view_size: u32,
    ...
    scope_render_request_size: u32,
    scope_symbol_size: u32,
    ...
    planner_query: usize,
    planner_result_view: usize,
    planner_result_copy: usize,
    planner_result_free: usize,
}
