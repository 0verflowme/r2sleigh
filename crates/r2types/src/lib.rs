...
pub use writeback::{
    ...
    StructDeclCandidate, StructDeclSource, StructFieldCandidate, TypeWritebackAnalysis,
    TypeWritebackAnalysisInput, TypeWritebackDiagnostics, TypeWritebackMutation,
    TypeWritebackMutationBudget, TypeWritebackMutationKind, TypeWritebackMutationPlan,
    TypeWritebackPlan, TypeWritebackSemanticInputs, VarRenameCandidate, VarTypeCandidate,
    WritebackEvidence, WritebackSource, apply_semantic_artifact_signature_hint_to_inferred,
