...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct NativeWorkerNameRouteFacts {
    pub display_summary_family: bool,
    pub canonical_summary_family: bool,
    pub summary_family: bool,
    pub summary_probe_name: String,
}

impl NativeWorkerNameRouteFacts {
    pub fn for_candidates<'a>(
        function_addr: u64,
        display_name: &str,
        canonical_name: &str,
        ...
        let summary_probe_name =
            first_supported_summary_name.unwrap_or_else(|| fallback_name.to_string());
...
mod tests {
    ...
    fn native_worker_name_route_facts_reject_raw_import_candidate_evidence() {
        let facts = NativeWorkerNameRouteFacts::for_candidates(
            ...
            "sym.imp.memcpy",
            "sym.imp.memcpy",
            ["fcn.00401000", "00401000", "sym.imp.memcpy", "memcpy"],
            "sym.imp.memcpy",
        );
    ...
    #[test]
    fn native_worker_name_route_facts_fall_back_without_route_evidence() {
        let facts = NativeWorkerNameRouteFacts::for_candidates(
            0x401000,
            "sym.worker",
            "fcn.00401000",
            ["fcn.00401000", "00401000", "sym.worker", "worker"],
            "sym.worker",
        );
        ...
        assert!(!facts.canonical_summary_family);
        assert!(!facts.summary_family);
        assert_eq!(facts.summary_probe_name, "sym.worker");
    }
