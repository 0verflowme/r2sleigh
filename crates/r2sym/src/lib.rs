...
pub use semantics::{
    ...
    normalize_native_worker_role_name, semantic_summary_has_modeled_evidence,
    semantic_summary_has_runtime_copy_role, stable_scope_hash, strong_vm_step_summary,
};
pub use sim::{
