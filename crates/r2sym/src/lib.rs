...
pub use semantics::{
    ...
    has_strong_vm_evidence, native_worker_summary_applicability_for_name,
    native_worker_summary_applicability_for_summary, native_worker_summary_route_policy_for_name,
    native_worker_summary_route_policy_for_summary, stable_scope_hash, strong_vm_step_summary,
};
pub use sim::{
