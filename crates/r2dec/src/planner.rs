...
pub(crate) fn preferred_vm_summary_reason(
    semantic_artifact: Option<&r2sym::SemanticArtifact>,
) -> Option<String> {
...
pub fn semantic_route_plan(
    ...
    if let Some(reason) = preferred_vm_summary_reason(semantic_artifact) {
